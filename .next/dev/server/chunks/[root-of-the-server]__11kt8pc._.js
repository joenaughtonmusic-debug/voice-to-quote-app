...
async function POST(request) {
    try {
        ...
        if (!response.ok) {
            const message = typeof result?.error?.message === "string" ? result.error.message : "OpenAI transcription request failed.";
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: message
            }, {
        ...
        if (typeof result?.text !== "string") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "OpenAI did not return transcript text."
            }, {
                status: 502
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__11kt8pc._.js.map